...
shr_exp_1   <- ctrvar_1_results[, 2:4 * 13 - 5]
shr_mse_1   <- ctrvar_1_results[, 2:4 * 13 - 1]
shr_5tier_1 <- ctrvar_1_results[, 2:4 * 13 + 3]
shr_cms_1   <- ctrvar_1_results[, 2:4 * 13 + 6]
shr_mpsc_1  <- ctrvar_1_results[, 2:4 * 13 + 7]


shr_exp_1_confound   <- ctrvar_1_confound_results[, 2:4 * 13 - 5]
shr_mse_1_confound   <- ctrvar_1_confound_results[, 2:4 * 13 - 1]
shr_5tier_1_confound <- ctrvar_1_confound_results[, 2:4 * 13 + 3]
shr_cms_1_confound   <- ctrvar_1_confound_results[, 2:4 * 13 + 6]
shr_mpsc_1_confound  <- ctrvar_1_confound_results[, 2:4 * 13 + 7]

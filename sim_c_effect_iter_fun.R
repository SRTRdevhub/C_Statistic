...
sim_c_effect_iter_fun <- function(curr_iter,
  ...
  op_char_mar <- c(mean(ctr_summary$ctr_exp),
                   ...
                   cor(ctr_summary$HR_unshr, ctr_summary$true_hr, method = "spearman"),
                   cor(ctr_summary$HR_shr, ctr_summary$true_hr, method = "spearman"),
                   cor(ctr_summary$obs_5tier_score, ctr_summary$true_hr, method = "spearman"),
                   cor(ctr_summary$obs_5tier, ctr_summary$true_hr, method = "spearman"),
                   cor(ctr_summary$obs_cms_flag, ctr_summary$true_hr, method = "spearman"),
                   cor(ctr_summary$obs_mpsc_flag, ctr_summary$true_hr, method = "spearman"),
  ...
  op_char_0_3 <- c(mean(ctr_summary$ctr_exp[ctr_summary$ctr %in% ctr_eval_0_3]),
                   ...
                   cor(ctr_summary$HR_unshr[ctr_summary$ctr %in% ctr_eval_0_3], 
                       ctr_summary$true_hr[ctr_summary$ctr %in% ctr_eval_0_3], method = "spearman"),
  ...
  op_char_3_10 <- c(mean(ctr_summary$ctr_exp[ctr_summary$ctr %in% ctr_eval_3_10]),
                    ...
                    cor(ctr_summary$HR_unshr[ctr_summary$ctr %in% ctr_eval_3_10], 
                        ctr_summary$true_hr[ctr_summary$ctr %in% ctr_eval_3_10], method = "spearman"),
  ...
  op_char_10_ <- c(mean(ctr_summary$ctr_exp[ctr_summary$ctr %in% ctr_eval_10_]),
                   ...
                   cor(ctr_summary$HR_unshr[ctr_summary$ctr %in% ctr_eval_10_], 
                       ctr_summary$true_hr[ctr_summary$ctr %in% ctr_eval_10_], method = "spearman"),
